          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <div className="flex items-center justify-between relative z-10">
                <span className="text-[9px] md:text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Total Scans</span>
              ...
              <div className="relative z-10">
                <p className="text-3xl md:text-4xl font-bold text-slate-900 tracking-tight">8,432</p>
                <div className="flex items-center gap-2 mt-2">
                  <span className="text-[9px] md:text-[10px] font-bold text-emerald-600 bg-emerald-50 px-2 md:px-2.5 py-0.5 rounded-full">+12.5%</span>
                  <span className="text-[10px] md:text-[11px] font-medium text-slate-400 italic">vs last month</span>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10">
                <p className="text-3xl md:text-4xl font-bold text-slate-900 tracking-tight">850<span className="text-lg md:text-xl text-slate-300 ml-1 font-medium">/ 1,000</span></p>
            ...
            >
              ...
              <div className="flex items-center justify-between relative z-10">
                ...
                <div className="w-7 h-7 md:w-8 md:h-8 rounded-lg bg-emerald-50 flex items-center justify-center">
                  <BarChart3 className="w-3.5 h-3.5 md:w-4 md:h-4 text-emerald-600" />
                </div>
              </div>
              <div className="relative z-10">
                <p className="text-3xl md:text-4xl font-bold text-slate-900 tracking-tight">2,105<span className="text-lg md:text-xl text-slate-300 ml-1 font-medium">/ 5,000</span></p>
                <div className="h-1.5 md:h-2 w-full bg-slate-100 rounded-full mt-4 overflow-hidden">
                  <motion.div 
                    initial={{ width: 0 }}
                    animate={{ width: "42.1%" }}
                  ...
                  <div key={idx} className="group">
                    <div className="flex justify-between items-end mb-3">
                      ...
                      <div className="flex items-baseline gap-1">
                        <span className="text-lg md:text-xl font-bold text-slate-900">{item.used}</span>
                        <span className="text-[10px] md:text-[11px] font-semibold text-slate-300">/ {item.total}</span>
                      </div>
                    </div>
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
              <div className="space-y-4 text-center md:text-left max-w-xl">
                <div className="inline-flex items-center gap-2 px-3 md:px-4 py-1 md:py-1.5 rounded-full bg-white/5 backdrop-blur-md border border-white/10">
                  ...
                  <span className="text-[9px] md:text-[10px] font-bold uppercase tracking-[0.2em] text-emerald-400">Plan: Pro Active</span>
                </div>
                <h3 className="text-2xl md:text-4xl font-bold tracking-tight">Ready to Scale?</h3>
                <p className="text-slate-400 font-medium text-xs md:text-sm leading-relaxed max-w-md">
                  You're currently using 85% of your Dynamic QR limits. Upgrade to Enterprise for unlimited capacity and dedicated support.
                </p>
              </div>
