      ...
      <div className="bg-[#0F6E56] p-6 sm:p-10 text-white relative shrink-0">
        ...
        <div className="text-xl sm:text-2xl font-black flex items-center gap-4 relative z-10">
          <div className="p-2 bg-white/20 rounded-xl backdrop-blur-md border border-white/10">
            <ShieldCheck className="h-5 w-5 sm:h-6 sm:w-6 text-emerald-300" />
          </div>
          Create API Key
        </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex bg-gray-50 p-1 rounded-xl border border-gray-100">
              <button
                ...
                className={cn(
                  "flex-1 py-2 text-[9px] sm:text-[10px] font-black uppercase tracking-widest rounded-lg transition-all",
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-3">
            {Object.entries(SCOPE_LABELS).map(([scope, label]) => (
              <div
                key={scope}
                className={cn(
                  "flex items-start gap-3 p-3.5 sm:p-4 border rounded-2xl transition-all cursor-pointer group",
              ...
              >
                ...
                <div className="space-y-0.5">
                  <label htmlFor={scope} className="text-[11px] sm:text-xs font-bold text-gray-900 block cursor-pointer">{scope}</label>
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between ml-1">
            ...
            <Button
              variant="ghost"
              size="sm"
              className="h-6 text-[8px] sm:text-[9px] font-black uppercase tracking-widest text-primary px-2"
              onClick={async (e) => {
                e.stopPropagation();
          ...
          <Input
            ...
            className="h-11 sm:h-12 bg-gray-50 border-gray-100 focus:border-emerald-500 focus:ring-emerald-500/20 rounded-xl font-medium text-sm"
          />
          <p className="text-[8px] sm:text-[9px] text-gray-400 font-medium ml-1">Comma-separated IPs or CIDR ranges. Leave empty to allow all IPs.</p>
        </div>
