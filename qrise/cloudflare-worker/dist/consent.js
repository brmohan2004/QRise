...
export function getConsentFromCookie(cookieHeader) {
    if (!cookieHeader)
        return null;
...
export function setConsentCookie(preferences) {
    ...
    return `qrise_consent=${value}; Path=/; Expires=${expires}; SameSite=Lax`;
}
export function buildConsentBanner(appUrl) {
    return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
export function getConsentHtml(appUrl) {
